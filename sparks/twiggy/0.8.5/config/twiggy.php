...
$config['twiggy']['default_public_theme'] = $CI->config->item('xe_default_public_theme');
$config['twiggy']['default_admin_theme'] = $CI->config->item('xe_default_admin_theme');
...
$config['twiggy']['register_functions'] = $CI->config->item('xe_autoload_twig_function');
