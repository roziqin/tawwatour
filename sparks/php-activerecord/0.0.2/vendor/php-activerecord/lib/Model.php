...
class Model
{
	...
	// TRY VERSION 3
	public function __isset($attribute_name) {
		$result = array_key_exists($attribute_name,$this->attributes) || array_key_exists($attribute_name,static::$alias_attribute);
        if($result)
            return true;
	...
	// 		if (method_exists($this, "get_$attribute_name"))
	//         {
	//             $attribute_name = "get_$attribute_name";
	//             $value = $this->$attribute_name();
	//             $result = $value;
	//         }
	//         $result = $this->read_attribute($attribute_name);
	// 	}
	// 	return $result;
	// }
	// 
